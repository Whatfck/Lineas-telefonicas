...
class Empresa:
    ...
    def darTotalMinutos(self):
        ...
        return self.linea1.totalMinutos() + self.linea2.totalMinutos() + self.linea3.totalMinutos() 
    '''
	    # Retorna el costo total de las llamadas realizadas.
	    # @return Costo total de las tres l�neas.
    '''
    def darTotalCostoLlamadas(self):
        # TODO Parte3 PuntoG: Completar el m�todo seg�n la documentci�n dada.
    ...
    def darCostoPromedioMinuto(self):
        ...
        return self.darTotalMinutos() / self.darTotalCostoLlamadas() 
    '''
    ...
    def reiniciar(self):
        ...
        self.linea1.reiniciar() self.linea2.reiniciar() self.linea3.reiniciar()
